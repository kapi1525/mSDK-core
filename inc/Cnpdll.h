...
// Modes ecran
// -----------
#define SM_DEFAULT	0x00		// Pour SetModeAppli: mode par d�faut
...
// Masques de bits d'�criture des plans de collision
...
typedef struct  Spr
{
	...
	int			sprHotSpotX;		// TODO: mettre en commentaires ceux qui ne sont pas utilis�s
	int			sprHotSpotY;
	int			sprWidth;
	int			sprHeight;
